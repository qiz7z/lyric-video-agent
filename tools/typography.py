...
W, H = 1080, 1440
FONT_CANDIDATES = [r"C:\Windows\Fonts\STXINGKA.TTF",   # 华文行楷（项目默认）
                   r"C:\Windows\Fonts\STXINWEI.TTF",   # 华文新魏
                   r"C:\Windows\Fonts\msyh.ttc"]       # 微软雅黑兜底
...
def render_cover(bg_path: str, title: str, subtitle: str, out_path: str,
                 workdir: str) -> str:
    ...
    out = Path(out_path)
    cmd = [get_ffmpeg(), "-y", "-i", str(bg_std), "-vf", vf,
